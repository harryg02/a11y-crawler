      ...
      <div>
        ...
        {mounted && (
          <div
            role="group"
            aria-label="Theme"
            className="inline-flex rounded-[5px] border-2 border-gray-300 dark:border-gray-700 overflow-hidden"
          >
            {THEMES.map(({ value, label }) => (
              <button
                ...
                className={`px-5 py-2 text-base font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-900 dark:focus:ring-white ${
                  theme === value
