  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className="w-15 h-12.5 text-center border-2 border-gray-600 rounded-[5px] text-white focus:border-white hover:border-gray-400 focus:outline-none transition-colors [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
      />
